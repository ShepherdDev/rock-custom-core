<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationEntryKiosk.ascx.cs" Inherits="RockWeb.Plugins.com_shepherdchurch.CustomCore.Event.RegistrationEntryKiosk" %>
<%@ Register Assembly="com.shepherdchurch.Misc" Namespace="com.shepherdchurch.Misc.UI.Controls" TagPrefix="SC" %>
...
<style>
    ...
    .body-content .rock-radio-button-list .controls label {
        padding: 8px;
        font-size: 1.5em;
        border-radius: 6px;
    ...
    .body-content .rock-radio-button-list .controls label > input {
        position: initial;
        margin-left: 0px;
        margin-right: 8px;
    }
...
<ContentTemplate>
    ...
    <asp:HiddenField ID="hfAutoReset" runat="server" />
    ...
    <script>
        ...
        Sys.Application.add_load(function () {
            var $autoReset = $('#<%= hfAutoReset.ClientID %>');
            if ($autoReset.val() != '')
            {
                setTimeout(function () {
        ...
        <asp:Panel id="pnlRegistrantFields" runat="server" >
            ...
            <div class="js-registration-same-family">
                <asp:Panel ID="pnlFamilyOptions" runat="server" CssClass="well">
                    <Rock:RockRadioButtonList ID="rblFamilyOptions" runat="server" Label="Individual is in the same family as" Required="true" RequiredErrorMessage="Answer to which family is required." DataTextField="Value" DataValueField="Key" />
                </asp:Panel>
            </div>
        
            <asp:Panel ID="pnlFamilyMembers" runat="server" Visible="false" CssClass="row" >
                <div class="col-md-12">
                    <Rock:RockRadioButtonList ID="ddlFamilyMembers" runat="server" Label="Family Member" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="ddlFamilyMembers_SelectedIndexChanged" />
                </div>
            </asp:Panel>
    ...
    <asp:Panel ID="pnlSummaryAndPayment" runat="server" Visible="false" CssClass="registrationentry-summary">
        ...
        <asp:Panel ID="pnlRegistrarInfo" runat="server" CssClass="well">
            ...
            <div class="row">
                <div class="col-md-6">
                    <SC:MaskedEmailBox ID="tbConfirmationEmail" runat="server" Label="Send Confirmation Emails To" Required="true" />
        ...
        <asp:Panel ID="pnlPaymentInfo" runat="server" CssClass="well">
            ...
            <asp:Panel ID="pnlKioskCard" runat="server" CssClass="js-swipe">
               <asp:Literal id="lSwipeErrors" runat="server" />
                ...
                <div class="text-center">
                    ...
                    <asp:Image ID="imgSwipe" runat="server" CssClass="img-responsive" ImageUrl="<%$ Fingerprint:~/Assets/Images/Kiosk/card_swipe.png %>" />
                </div>
            </asp:Panel>

            <asp:Panel ID="pnlKeyCard" runat="server" Visible="false">
        ...
        <asp:Panel ID="pnlCostAndFees" runat="server">
            ...
            <div class="row fee-totals">
                <div class="col-sm-12 fee-totals-options">
    ...
    <asp:Panel ID="pnlSuccess" runat="server" Visible="false" >
        ...
        <div class="actions">
            <asp:LinkButton ID="lbSuccessDone" runat="server" OnClick="lbSuccessDone_Click" CssClass="btn btn-primary pull-right" Text="Done" />
        </div>
