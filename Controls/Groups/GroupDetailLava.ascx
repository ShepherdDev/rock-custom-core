<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupDetailLava.ascx.cs" Inherits="RockWeb.Plugins.com_shepherdchurch.CustomCore.Groups.GroupDetailLava" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlGroupEdit" runat="server" Visible="false">
            ...
            <div class="row">
                <div class="col-md-12">
                    <asp:PlaceHolder ID="phAttributes" runat="server" EnableViewState="true" Visible="false" />
                </div>
            </div>
