<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupRegistration.ascx.cs" Inherits="RockWeb.Plugins.com_shepherdchurch.CustomCore.Groups.GroupRegistration" %>
